...
| 224 | `224-zao-stock-multi-year-vision` | ZAO Stock multi-year vision: culture + art + music + tech conference/festival, 5-year roadmap (1-day festival → 7-day summer camp), Network School model adapted for artists, Ellsworth summer concert integration, Departure/NFC/CURRENTS/Ars Electronica comparison, virtual-to-IRL pipeline, workshop curriculum (4 tracks), revenue model ($15K→$500K), "Create, Connect, Own" |
