...
**Today the lab includes:** the original Farcaster client for The ZAO, the ZAOstock dashboard + Telegram bot (spinout planned but NOT done - still the #2 hottest area in-repo as of 2026-07-03), agent stack (ZOE, the orchestrator), music player components, ~960 research docs. 306 API routes, 296 components, 18 hooks, 44 lib domains. (Counts verified 2026-07-03 - see [Doc 836](research/infrastructure/836-zaoos-repo-estate-census/).)
...
| `src/lib/` | Utils across 44 domains: auth, db, farcaster, music, publish, agents, livepeer, unlock | Working on business logic |
...
| `research/` | ~960 research docs (see research/README.md) | Use grep, not bulk reads |
