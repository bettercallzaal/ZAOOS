...
### Signage Needed
- [ ] Stage backdrop banner (large, 6-8 ft wide)
- [ ] Welcome/entrance sign or A-frame
- [ ] Sponsor logos banner (near stage or at entrance)
- [ ] Wayfinding signs: "Parking →", "Food →", "Restrooms →", "After-party at Black Moon →"
- [ ] Merch table banner
- [ ] QR code signs for: RSVP, digital collectible, tips/donations, social handles
- [ ] Lineup card (small, printed, take-home)
...
| Item | Quantity | Size | When to Order | Estimated Cost |
|------|----------|------|---------------|----------------|
| Stage backdrop banner | 1 | 6-8 ft wide | August | $50-$150 |
| Welcome A-frame sign | 1 | Standard A-frame | August | $30-$60 |
| Sponsor banner | 1 | 4-6 ft | September (after sponsors confirmed) | $40-$100 |
| Wayfinding signs | 5-8 | Small directional | September | $20-$40 |
| Lineup cards | 200 | Postcard size | September (after lineup locked) | $30-$50 |
| Flyers for pre-promotion | 200 | Standard flyer | July-August | $20-$40 |
| QR code signs | 4-6 | Tabletop size | September | $10-$20 |
| **Total estimated** | | | | **$200-$460** |

---

## Digital Assets Needed

- [ ] Social media graphics (Farcaster/X size, Instagram size)
- [ ] Lineup announcement graphic (when ready)
...
- Small-town Maine craft fairs (rustic, handmade, warm)
- Independent record shop flyers (bold type, limited colors)
- DIY punk/indie show posters (energy, rawness, authenticity)
- NOT: Coachella, EDM festivals, corporate event branding
- NOT: Overdesigned, too many colors, too much polish

The vibe is: "a group of friends put on a music festival in their town and made it look good."
