...
> [!NOTE]
> **ZAO OS launched March 12, 2026 with 40 beta testers.** This MVP spec is retained as the original design document. For current state, see [Doc 50](../050-the-zao-complete-guide/).
