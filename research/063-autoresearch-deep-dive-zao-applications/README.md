...
- [Doc 62 — Autoresearch: Skill Improvement](../062-autoresearch-skill-improvement/) — our initial research and first application to `/zao-research`
- [Doc 57 — Security Audit March 2026](../057-codebase-security-audit-march-2026/) — existing security findings to guard against regression
- [Doc 44 — Agentic Development Workflows](../044-agentic-development-workflows/) — Claude Code as persistent dev partner
