...
- [Doc 202 — Multi-Agent Orchestration](../202-multi-agent-orchestration-openclaw-paperclip/) — Three-layer hierarchy, OpenClaw supervising Paperclip workers
- [Doc 204 — OpenClaw Setup Runbook](../204-openclaw-setup-runbook/) — VPS config, phase-by-phase deployment
- [Doc 174 — Paperclip Multi-Company](../174-paperclip-multi-company-agents/) — Task hierarchy, delegation patterns, cross-team work
- [Doc 175 — Paperclip ClipMart + Plugins](../175-paperclip-clipmart-plugins/) — Plugin architecture, ZAO-specific plugin designs
- [Doc 208 — OpenClaw Skills & Capabilities](../208-openclaw-skills-capabilities/) — 52 installed skills, 82 extensions, channel integrations
