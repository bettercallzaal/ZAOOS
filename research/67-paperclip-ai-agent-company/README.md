...
- [Doc 24 — ZAO AI Agent](../24-zao-ai-agent/) — ElizaOS architecture, 4-phase rollout
- [Doc 26 — Hindsight Agent Memory](../26-hindsight-agent-memory/) — 91.4% accuracy memory system
- [Doc 44 — Agentic Development Workflows](../44-agentic-development-workflows/) — Claude Code as dev partner
- [Doc 46 — OpenFang Agent OS](../46-openfang-agent-os/) — evaluated and rejected (Rust, no Farcaster)
- [Doc 50 — The ZAO Complete Guide](../50-the-zao-complete-guide/) — canonical ecosystem reference
