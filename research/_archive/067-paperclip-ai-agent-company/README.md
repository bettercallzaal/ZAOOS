...
- [Doc 24 — ZAO AI Agent](../../_archive/024-zao-ai-agent/) — ElizaOS architecture, 4-phase rollout
- [Doc 26 — Hindsight Agent Memory](../../agents/026-hindsight-agent-memory/) — 91.4% accuracy memory system
- [Doc 44 — Agentic Development Workflows](../../_archive/044-agentic-development-workflows/) — Claude Code as dev partner
- [Doc 46 — OpenFang Agent OS](../../_archive/046-openfang-agent-os/) — evaluated and rejected (Rust, no Farcaster)
- [Doc 50 — The ZAO Complete Guide](../../community/050-the-zao-complete-guide/) — canonical ecosystem reference
