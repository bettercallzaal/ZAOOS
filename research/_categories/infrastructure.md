...
| [220](../220-mobile-first-music-ux-patterns/) | **Mobile-First Music App UX Patterns** | 10-topic mobile UX research: thumb zones, Spotify/Apple Music patterns, audio room UX, PWA iOS limits, live streaming UI, gesture controls, haptics (web-haptics pkg), notifications, web3 wallet, 4-phase implementation plan |
| [225](../225-fork-friendly-open-source-patterns/) | **Fork-Friendly Open-Source Patterns** | Cal.com, Dub.co, Ghost, Discourse, Mastodon forkability patterns. AGENTS.md, FORK.md, deploy buttons, AI-agent-friendly docs, env var categorization |
