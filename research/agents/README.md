...
| 462 | [Hyperspell Company Brain Pattern](./462-hyperspell-company-brain-context-graph/) | CANONICAL | Build-vs-buy on Hyperspell (YC F25, 312K-view thread). REJECT buy. ADOPT thesis: build BRAIN/ in zao-memory repo + nightly synthesis Routine. 4-tier source authority, FID-based identity resolution, freshness tracking. First prototype: BRAIN/projects/zao-stock. |
