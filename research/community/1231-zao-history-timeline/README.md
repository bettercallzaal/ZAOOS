...
| May 2025 | Zaal attends **FarCon NYC** (Brooklyn, 1-2 May) as a guest. Onchain Builder House, House of Nouns, FarCon Summit, The Forever Library. | Documented in his own "Farcon NYC 2025" playlist. **RETRACTION 2026-09-07:** this row previously asserted a **"Lil WaveWarZ Takeover at NFT NYC"** IRL event as "the third consecutive IRL proof point". **It never happened - the proposal did not pass** (Zaal, 2026-09-07). It entered the record from a HackMD team roster line about a PLANNED takeover, which doc 742 logged as "Shipped". Row 53 then carried it with year only and no venue and no [VERIFY] flag, and five downstream surfaces repeated it including a published card. **Do not restore.** |
