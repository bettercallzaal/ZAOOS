...
- **THE TWO BIG VIDEOS ARE NOW UNLOCKED — and they change the biography.** A later pass cracked the transcripts of both "The 365 Documentary" (Jan 2026) and the Steve Reynoso podcast (Jul 2025) via local yt-dlp. Major new biographical facts surfaced: a **2024 year in Thailand** training Muay Thai (he "put a pause on my dreams"); **he lost the entire UVR community while away** (the real underlying "why" of the Twitch rebuild); a **$10,000 crypto-wallet drain** that wiped two years of web3 music earnings; a year of **intrusive-thought OCD** he attributes getting out of to quitting weed and reigniting music; the LA shipping container was **$150 in Skid Row**; he ended the 365 by flying home to surprise his mom in his **childhood bedroom**. Full synthesis + cleaned transcripts in [08-primary-sources-unlocked.md](08-primary-sources-unlocked.md) and `transcripts/`.

Full detail is in the sub-docs: biography material in **[02-biography-source-material.md](02-biography-source-material.md)**, the Jan 2025-May 2026 Twitch chapter in **[03-twitch-era-deep-dive.md](03-twitch-era-deep-dive.md)**, the Twitch-era business analysis in **[04-twitch-era-business-model.md](04-twitch-era-business-model.md)**, the supporting cast in **[05-supporting-cast.md](05-supporting-cast.md)**, the music and visual art in **[06-the-art.md](06-the-art.md)**, the reconciled timeline + critical lens + press archive in **[07-timeline-criticism-sources.md](07-timeline-criticism-sources.md)**, the primary-source transcripts and what they revealed in **[08-primary-sources-unlocked.md](08-primary-sources-unlocked.md)**, and the technical builders + clip ecosystem + derivative layer in **[09-builders-and-derivative-layer.md](09-builders-and-derivative-layer.md)**.
...
- [08-primary-sources-unlocked.md](08-primary-sources-unlocked.md) — the two big videos finally cracked: the 365 Documentary + Steve Reynoso podcast transcripts, the major new facts (Thailand year, wallet drain, OCD, Skid Row), and the reproducible yt-dlp method
- [09-builders-and-derivative-layer.md](09-builders-and-derivative-layer.md) — the technical builders behind the projects, the clip ecosystem, and the (thin) fan/derivative layer
- `transcripts/` — cleaned full-text transcripts of the 365 Documentary and the Steve Reynoso podcast
