...
| **[CORRECTION] Workflows 2-3 already built, not future work** | - | Note | - | Both shipped this session as inactive JSON: Workflow 2 (newsletter → draft cross-posts, PR #1160) and Workflow 3 (GitHub PR merged → tracker + Telegram, PR #1161). Workflow 2 is drafts-only by design (no auto-posting), not "active" as this doc originally assumed - matches the n8n-as-plumbing boundary, not a gap to close. |
| **[CONDITIONAL] Activate Workflow 2 (newsletter drafts)** | Zaal | Activation | 2026-07-25 | Zaal reviews draft output quality over first few newsletter issues, decides whether to activate as-is or add real posting later |
| **[CONDITIONAL] Activate Workflow 3 (GitHub PR tracker)** | Zaal | Activation | 2026-08-01 | Zaal spot-checks a few auto-capture tracker rows for accuracy, then activates |
