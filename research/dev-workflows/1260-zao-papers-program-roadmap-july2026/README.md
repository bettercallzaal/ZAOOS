# 1260 -- ZAO Papers Program: Whitepaper Status + Publishing Roadmap (July 2026)
...
- Source: doc 1258, zabalgames repo
...
| Doc | Relevance |
|-----|-----------|
| doc 1257 | ZAO IP Portfolio fact sheet (canonical numbers for all papers) |
| doc 1256 | COC Concertz series record (source for COC paper) |
| doc 1258 | ZABAL Games mid-season audit (source for ZABAL Games paper) |
| doc 1077 | WaveWarZ volume deep dive (source for WaveWarZ paper) |
| bettercallzaal/zao-papers | The papers repo |
