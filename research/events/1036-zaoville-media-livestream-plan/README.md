...
| ~~Decide the all-day pool-party media coverage plan~~ - ANSWERED 2026-07-12: full switched setup at a safe distance from the pool deck (not POV/glasses-only) | Zaal | Done | 2026-07-12 |
| ~~Name one person to own pre-event content capture~~ - ANSWERED 2026-07-12: Zaal, given Trey and ELYVN already independently asked about livestreaming the drive-down and doing interviews before the pool party (Finding 4) | Zaal | Done | 2026-07-12 |
