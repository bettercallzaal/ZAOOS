...
- [Doc 202 — Multi-Agent Orchestration](../../agents/202-multi-agent-orchestration-openclaw-paperclip/) — 3-layer architecture
- [Doc 204 — OpenClaw Setup Runbook](../../_archive/204-openclaw-setup-runbook/) — VPS config
- [Doc 205 — Deployment Plan](../../agents/205-openclaw-paperclip-elizaos-deployment-plan/) — Phase 1-3 steps
