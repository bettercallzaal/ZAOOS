...
| 796 | [The WIP Meetup: Web3 Metaverse Community](./796-the-wip-meetup-metaverse-community/) | STANDALONE | Longest-running web3 metaverse meetup (Thursdays 12pm PT since 2019, run by niftytime/rizzle/Meme inside Hyperfy). Steal the fixed weekly ritual + persistent 3D room; evaluate Hyperfy v2 (AI-agent NPCs) as the venue for ZAO's portal hub instead of bespoke R3F. $HYPER token-for-attendance precedent maps to Respect rewards. |
