...
5. **LIVE CONFLICT, found 2026-09-26: the ZAO Fractal whitepaper drafts propose decaying Respect balances, which Season 3 forbids.** `whitepaper/draft/ch04-the-respect-token.md` in ZAODEVZ/ZAOfractal, section VI, says a weekly decay model "is under consideration for the next-generation Respect token... At the start of each week, balances would shrink by 2%... Over time, if a member stops contributing, their balance would decay to zero", with a stated half-life of 34.3 weeks; ch05 repeats it. Its stated purpose is the same problem Season 3 solves: "to keep governance weighted toward recent contribution rather than letting long-inactive members hold power forever". Season 3's answer is that the pool changes and the balance never does (brainstorm #1, ZIP-2 Backwards Compatibility). Both documents are live and they answer the same question in opposite ways. NEEDS ZAAL: one of them has to give, and this doc's own evidence favours Season 3's answer - every decay system found here (Colony, Gardens, Coordinape, fractally's moving average) decays the WEIGHT or the scoring input, never the earned record. Verified by reading both chapters through gh api on 2026-09-26.

6. **Not a contradiction, a closure:** brainstorm #20 ("what counts as attending") was still listed as open on the lane board. ZIP-2 section 3 records that Zaal ruled on it on 2026-09-15: a fractal, hosting a call, making an intro, a festival, an article or a workshop count; signature alone does not.
