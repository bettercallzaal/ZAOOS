...
| Doc | Relevance |
|-----|-----------|
| [150 — Arweave Storage](../../_archive/150-arweave-permanent-music-storage/) | Basic Arweave intro (superseded by this doc for upload tool choice) |
| [151 — Distribution Without Zora](../../music/151-zounz-distribution-without-zora/) | Uses Arweave + thirdweb + 0xSplits stack |
| [149 — BuilderOSS Deep Dive](../../governance/149-buildeross-deep-dive-everything/) | ZOUNZ governance layer |
| [33 — Infrastructure & Storage](../../_archive/033-infrastructure-mobile-storage/) | Original storage strategy (Arweave for NFTs) |
| [128 — Music Player Audit](../../music/190-music-player-complete-audit/) | Existing player infrastructure |
| [138 — Play Counting](../../music/138-play-counting-stream-attribution/) | Stream attribution (AO could replace) |
