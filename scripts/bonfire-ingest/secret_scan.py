...
if __name__ == "__main__":
    ...
    # Self-test
    test = """
    Real Anthropic key: sk-ant-abc123def456ghi789jkl0mn
    Real GitHub: ghp_aBcDeFgHiJkLmNoPqRsTuVwXyZ0123456789
    Server IP 187.77.3.104
    Email zaal@gmail.com (personal)
    Public email zaal@thezao.com (intentional)
    Wallet 0x1234567890123456789012345678901234567890123456789012345678901234
    -----BEGIN PRIVATE KEY-----
    Bot token 8925521557:AAE3jAgM-omEq9txXYyzSSEpbmHi1FSxjhw
    POSTGRES_URL=postgresql://admin:realPassword123@db.example.com:5432/mydb
    ...
    --- These SHOULD trigger HIGH ---
    OPENAI_API_KEY=sk-proj-RealLookingKey1234567890AbCdEfGhIjKlMnOpQrSt
    JWT_SECRET=jX9k2mP4nQ7rS5tV8wY1zA3bC6dE9fG2hI5jK8lM
    """
