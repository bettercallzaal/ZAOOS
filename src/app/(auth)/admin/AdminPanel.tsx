...
const AllowlistTable = dynamic(
  () => import('@/components/admin/AllowlistTable').then((m) => ({ default: m.AllowlistTable })),
  { ssr: false },
);
...
const ZidManager = dynamic(
  () => import('@/components/admin/ZidManager').then((m) => ({ default: m.ZidManager })),
  { ssr: false },
);
const CsvUpload = dynamic(
  () => import('@/components/admin/CsvUpload').then((m) => ({ default: m.CsvUpload })),
  { ssr: false },
);
const HiddenMessages = dynamic(
  () => import('@/components/admin/HiddenMessages').then((m) => ({ default: m.HiddenMessages })),
  { ssr: false },
);
const RespectOverview = dynamic(
  () => import('@/components/admin/RespectOverview').then((m) => ({ default: m.RespectOverview })),
  { ssr: false },
);
const PollConfigEditor = dynamic(
  () =>
    import('@/components/admin/PollConfigEditor').then((m) => ({ default: m.PollConfigEditor })),
  { ssr: false },
);
const DiscordLinkManager = dynamic(
  () =>
    import('@/components/admin/DiscordLinkManager').then((m) => ({
      default: m.DiscordLinkManager,
    })),
  { ssr: false },
);
const EngagementOverview = dynamic(
  () =>
    import('@/components/admin/EngagementOverview').then((m) => ({
      default: m.EngagementOverview,
    })),
  { ssr: false },
);
...
const OnboardingFunnel = dynamic(() => import('@/components/admin/OnboardingFunnel'), {
  ssr: false,
});
const DormantMembers = dynamic(
  () => import('@/components/admin/DormantMembers').then((m) => ({ default: m.DormantMembers })),
  { ssr: false },
);
const SpacesManager = dynamic(
  () => import('@/components/admin/SpacesManager').then((m) => ({ default: m.SpacesManager })),
  { ssr: false },
);
const AgentDashboard = dynamic(() => import('@/components/admin/agents/AgentDashboard'), {
  ssr: false,
});
const RolodexDashboard = dynamic(
  () =>
    import('@/components/admin/rolodex/RolodexDashboard').then((m) => ({
      default: m.RolodexDashboard,
    })),
  { ssr: false },
);
const NexusLinksManager = dynamic(
  () =>
    import('@/components/admin/NexusLinksManager').then((m) => ({ default: m.NexusLinksManager })),
  { ssr: false },
);
