      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-[#0d1b2a]/50 rounded-xl p-5 border border-white/[0.08]">
          ...
          <p className="text-sm text-gray-400 mb-4">
            Report bugs, request features, or suggest improvements. Issues go directly to the ZAO AI
            team for triage.
          </p>
          <IssueSubmitForm />
        </div>
        ...
        <div className="bg-[#0d1b2a] rounded-xl p-4 border border-white/[0.08]">
          ...
          <p className="text-sm text-gray-400">
            ZAO OS is built transparently. Every decision, every line of code, documented and
            shared. 74 research docs and counting.
          </p>
        </div>
      </div>
    </div>
