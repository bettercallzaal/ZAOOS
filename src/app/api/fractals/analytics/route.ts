...
export async function GET() {
  ...
  try {
    const [membersResult, sessionsResult, scoresResult, topByFractalResult, recentSessionsResult] =
      await Promise.all([
        supabaseAdmin
        ...
        supabaseAdmin.from('fractal_scores').select('score, rank, wallet_address'),
