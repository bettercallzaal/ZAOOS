...
const PROJECTS: Project[] = [
  {
    ...
    creator: 'Abraham Nash',
    sales: 45108,
    match: 502,
    category: 'DeSci / AI',
    blurb:
      'Decentralized AI training network (DIN) out of Oxford — data stays local, models go to the commons.',
    zaoTie: 'Researched in the ZAO library (doc 760)',
  },
  {
    rank: 2,
    name: 'Edge Esmeralda 2026',
    creator: 'Telamon Ardavanis',
    sales: 30569,
    match: 2677,
    category: 'Human Flourishing',
    blurb:
      'A month-long gathering in Northern California for people building a brighter future (May 30 - June 27, 2026).',
    zaoTie: 'ZAO x Edge City collaboration channel open',
  },
  {
    rank: 3,
    ...
    category: 'Music',
    blurb:
      'From women to the world — a journey of voice and vibration. Music, stories, and sacred sounds.',
  },
  {
    rank: 4,
    ...
    category: 'Fellowship',
    blurb:
      'A fellowship funding exceptional builders under 25 to spend a month at Edge City on frontier fields.',
  },
  {
    rank: 5,
    name: 'Gaian Temple',
    ...
    category: 'Sound',
    blurb:
      'Temple of Sound: listening experiments, concerts, installations, and biosphere network communication.',
  },
  {
    rank: 6,
    name: 'Coralverse - Reef Revival',
    creator: 'ZCreative Media',
    sales: 7464,
    match: 0,
    category: 'Gaming',
    blurb: 'Combining adventure gaming with real-world reef conservation.',
  },
  {
    rank: 7,
    name: 'Memethology',
    ...
    match: 508,
    category: 'Community',
    blurb: 'A trading card game about tech, culture, and human flourishing.',
  },
  {
    rank: 8,
    name: 'HERITAGE COLLECTION: Fashion, Music & Blockchain Show',
    creator: 'Gneric',
    sales: 5810,
    match: 634,
    category: 'Fashion',
    blurb: 'A multidisciplinary fashion, music, and blockchain showcase.',
  },
  {
    rank: 9,
    name: 'ToGather Project, Documenting Living Systems',
    creator: 'Sharon',
    sales: 5712,
    match: 45,
    category: 'Community',
    blurb:
      'Better communities are being built right now. This platform is where their experience becomes part of the commons.',
  },
  {
    rank: 10,
    name: 'HOPE',
    ...
    match: 669,
    category: 'Discovery',
    blurb: 'An EP of five experimental tracks ministering hope out of brokenness.',
  },
  {
    rank: 11,
    name: 'ENTERTAINMENT EVOLVED',
    creator: 'Matthew Chan',
    sales: 4910,
    match: 200,
    category: '360 Experience',
    blurb: 'You will believe a man can become content.',
  },
  {
    rank: 12,
    name: "The Owl's Nest: Regenerative Arts Gathering",
    creator: 'Eska',
    sales: 4549,
    match: 0,
    category: 'Regenerative Culture',
    blurb:
      'A 5-day gathering of 50 makers on a reforestation site: land art, ritual, and ecological skill-sharing.',
  },
  {
    rank: 13,
    name: 'Regen Reef',
    ...
    category: 'ReFi',
    blurb:
      'Marine biotech, socio-ecological restoration, and ReFi — modular wet labs for coral and fish.',
  },
  {
    rank: 14,
    name: 'Cinemetropolis',
    ...
    blurb:
      'A mixed-reality world where AR expands real miniatures into one connected movie universe you can step inside.',
  },
  {
    rank: 15,
    name: 'Sonic Sanctuary: A Journey Through Sound',
    creator: 'Plexonerz',
    sales: 3562,
    match: 270,
    category: 'Electronic Music',
    blurb:
      'Electronic music as a sonic journey — introspection and the feeling that resides deep within us.',
  },
  {
    rank: 16,
    name: 'International Artists Project',
    creator: 'International Artists Project',
    sales: 3215,
    match: 270,
    category: 'Community',
    blurb:
      'A global music community uplifting artists born in every country, preserving hundreds of languages and genres.',
  },
  {
    rank: 17,
    name: 'CHAINWARS .wtf — Cypherpunk Space-Opera',
    creator: 'Fly you fools .wtf',
    sales: 2072,
    match: 107,
    category: 'Journalism',
    blurb:
      "An epic docu-myth from inside crypto's war room. Stories the whitepapers were protecting you from.",
  },
  {
    rank: 18,
    name: 'THE NEW VANGUARD',
    creator: 'Enrico',
    sales: 1965,
    match: 250,
    category: 'Photography',
    blurb:
      'A cinematic archive of Nigerian identity, documenting a generation and educating communities on Web3 cultural preservation.',
  },
  {
    rank: 19,
    name: 'DeSci Asia',
  ...
  {
    rank: 20,
    name: 'Participatory Spatial Music Show',
    creator: 'Joel DeJong',
    sales: 1375,
    match: 0,
    category: 'Participatory Art',
    blurb: 'A live, co-created entertainment series.',
  },
  {
    rank: 21,
    name: 'HuRya Empowerment Foundation (Poly Raiders)',
    creator: 'Poly Raiders',
    sales: 1190,
    match: 40,
    category: 'Impact',
    blurb:
      "Web3 art fuels dignity for thousands of girls through pads, kids' education, and a vocational center.",
  },
  {
    rank: 22,
    name: 'The Creator Block',
    creator: 'KOSBAA',
    sales: 1080,
    match: 500,
    category: 'Creator Economy',
    blurb: 'A two-day summit where creators showcase their work and learn how to own it onchain.',
  },
  {
    rank: 23,
    name: 'THE ART FACTORY',
    creator: 'Gidzeey',
    sales: 978,
    match: 58,
    category: 'Music',
    blurb:
      'One stage play each month telling Nigerian stories, paying creatives, and using Web3 to build lasting support.',
  },
  {
    rank: 24,
    name: 'The MOTHERLand Project',
    creator: 'Tarzaa Gerald Caesar (CZA OF REM)',
    sales: 950,
    match: 0,
    category: 'Infrastructure',
    blurb:
      'A women-led cultural infrastructure uniting music, film, AI tools, and digital ownership.',
  },
  {
    rank: 25,
    name: 'The Space — a Home for Activists in Israel-Palestine',
    creator: 'Sapirs55',
    sales: 925,
    match: 0,
    category: 'Peacebuilding',
    blurb:
      'A protected community space for activists building justice, solidarity, and political imagination.',
  },
  {
    rank: 26,
    name: 'Ear of Dionysus: Listening as a Frontier Technology',
    creator: 'The Decentralised Cult of Quantum Listening',
    sales: 480,
    match: 80,
    category: 'Sound',
    blurb:
      'An immersive sound lab and sonic theater at ancient sites, exploring quantum listening through Dionysian ritual.',
  },
  {
    rank: 27,
    name: 'Artisanal Intelligence',
    creator: 'KNOTTO',
    sales: 400,
    match: 0,
    category: 'Craftsmanship',
    blurb:
      'An exhibition world tour about endangered crafts, design, and cultural exchange between Europe and Japan.',
  },
  {
    rank: 28,
    name: 'America 250 - Echoes of Freedom AR Tour',
    creator: 'Trishgiaart',
    sales: 385,
    match: 0,
    category: 'Augmented Reality',
    blurb: 'A site-specific augmented reality public-art and history XR project.',
  },
  {
    rank: 29,
    name: 'Thread of Hope',
    creator: 'whyldwanderer',
    sales: 215,
    match: 0,
    category: 'Women Empowerment',
    blurb:
      'Palestinian women in Cairo rebuilding identity, community, and livelihoods through the living tradition of Tatreez.',
  },
  {
    rank: 30,
    name: 'Hip-Hop Africa',
    creator: 'Hiphop Africa',
    sales: 110,
    match: 0,
    category: 'Multi-Media',
    blurb:
      'Building a unified platform for African hip hop through community, online radio, events, festivals, and awards.',
  },
  {
    rank: 31,
    name: 'ANFT',
    ...
    blurb:
      'A decentralized, authorship-first digital painting marketplace where every artwork is painted within the platform.',
  },
  {
    rank: 32,
    ...
    category: 'Music',
    blurb:
      'Bringing awareness to social-good projects with cultural exchange through live music between project speakers.',
  },
];
...
const LIKEMINDED: LikemindedFund[] = [
  {
    name: 'Greenpill Fund for Regenerative Gatherings',
    theme: 'Local events that bring regenerative communities together',
  },
  {
    name: 'Funding the Commons Frontier Fund',
    theme: 'Infrastructure, research, and cultural work for the commons',
  },
  { name: 'Terminus Fund', theme: 'Sovereign communities and network-state experiments' },
  {
    name: 'Hubs Network Fund for Solarpunk Spaces',
    theme: 'Independent physical spaces for culture, care, and governance',
  },
];
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <header className="mb-10">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-white/70 sm:text-base">
            ...
            community organizers building collaborative cultural experiences — at the intersection
            of art, emerging technology, and real-world activation. Directed by Zaal on{' '}
            <a
        ...
        <section className="mb-12">
          ...
          <div className="rounded-2xl border border-[#f5a623]/40 bg-gradient-to-br from-[#f5a623]/10 to-transparent p-6">
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/70">
              One of the best ways to back {featured.creator}: collect their Artifact. Because they
              are part of the ZAO Fund, every dollar they raise unlocks matching from the fund, paid
        ...
        <section className="mb-12 rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-3 text-sm leading-relaxed text-white/70">
            ...
            <span className="text-white">Artifact</span>, and every dollar of sales unlocks a
            matching dollar from each fund backing that project, while the pool lasts. A project
            curated into multiple funds gets matched by each — so broad backing multiplies a
            creator&apos;s raise. We back emerging tech used as infrastructure for shared ownership
            and fair compensation, not as a gimmick.
          </p>
          <div className="mt-5">
        ...
        <section className="mb-12">
          <div className="mb-5 flex items-baseline justify-between">
            ...
            <span className="text-xs text-white/50">
              Ranked by sales — snapshot {SNAPSHOT_DATE}
            </span>
          </div>
              ...
              >
                <div className="flex gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {p.zaoTie ? (
                      <p className="mt-2 text-xs font-medium text-[#f5a623]">
                        ZAO link: {p.zaoTie}
                      </p>
                    ) : null}
        ...
        <section className="mb-12 rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-3 text-sm leading-relaxed text-white/70">
            Artizen is a Web3 crowdfunding and match-funding platform for projects at the
            intersection of art, science, technology, and culture, founded by René Pinnell. Creators
            mint $10 open-edition Artifacts — 100% goes to the creator — and every dollar of sales
            instantly unlocks a matching dollar from each fund backing the project. As of June 2026
            a rebuilt platform is running weekly match drives: the Phoenix Fund Drive raised{' '}
          ...
          <p className="mt-3 text-xs text-white/40">
            Standings on this page are a point-in-time snapshot ({SNAPSHOT_DATE}) and move as
            artifacts sell. The{' '}
            <a
              href={FUND_URL}
              className="text-[#f5a623] underline-offset-2 hover:underline"
