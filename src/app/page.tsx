    ...
    <main className="min-h-[100dvh] flex flex-col bg-[#0a1628] relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pt-12 pb-8 relative z-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-10">
          {[
            {
              icon: 'M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772',
              label: 'Community',
            },
            {
            ...
            >
              <svg
                className="w-3.5 h-3.5 text-[#f5a623]/70"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth={1.5}
      ...
      <div className="px-6 pb-8 relative z-10">
        <div className="max-w-sm mx-auto">
          <div className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-4">
            <p className="text-xs text-gray-400 text-center mb-2">Not a member yet?</p>
