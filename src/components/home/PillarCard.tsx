...
export function PillarCard({ icon, label, href, badge }: PillarCardProps) {
  return (
    <Link
      href={href}
      className="group relative bg-[#0d1b2a] border border-white/[0.08] rounded-xl p-4 flex flex-col items-center justify-center gap-2 hover:border-[#f5a623]/30 transition-all hover:bg-[#0d1b2a]/80"
    >
