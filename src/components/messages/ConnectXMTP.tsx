  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
      ...
      <p className="text-sm text-gray-400 max-w-sm mb-2">
        End-to-end encrypted messaging powered by XMTP. DM other ZAO members or create private group
        chats.
      </p>
      ...
      <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-[#f5a623]/5 border border-[#f5a623]/10 max-w-sm mb-6">
        ...
        <p className="text-[11px] text-gray-400">
          One-time wallet signature required. No gas fees. Your messages are end-to-end encrypted.
        </p>
      </div>
            ...
            {allWallets.map((w) => (
              ...
              >
                ...
                {!w.isWagmi && effectiveSelected === w.address && (
                  <span className="text-[10px] text-[#f5a623] flex-shrink-0 ml-2">
                    Switch wallet first
                  </span>
                )}
              </button>
