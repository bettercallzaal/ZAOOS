      ...
      <div className="flex h-[100dvh] bg-[#0a1628] text-white">
        <aside className="hidden md:flex w-64 bg-[#0d1b2a] border-r border-white/[0.08] flex-col">
          ...
          <div className="p-4 border-t border-white/[0.08]">
            <Link href="/chat" className="flex items-center gap-2 text-sm text-gray-400 hover:text-white transition-colors">
      ...
      {showList && (
        <div className={`${isMobile ? 'w-full' : 'w-80 border-r border-white/[0.08]'} bg-[#0d1b2a] flex flex-col`}>
          <div className="px-4 pt-3 pb-1 flex items-center justify-between">
            <Link href="/chat" className="inline-flex items-center gap-1.5 text-xs text-gray-500 hover:text-white transition-colors">
