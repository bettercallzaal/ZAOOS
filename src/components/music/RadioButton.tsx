        ...
        {radioLoading ? (
          ...
          >
            <path
              ...
              d="M3.75 7.5l16.5-4.125M12 6.75c-2.708 0-5.363.224-7.948.655C2.999 7.58 2.25 8.507 2.25 9.574v9.176A2.25 2.25 0 004.5 21h15a2.25 2.25 0 002.25-2.25V9.574c0-1.067-.75-1.994-1.802-2.169A48.329 48.329 0 0012 6.75zm-1.683 6.443l-.311.07a1.027 1.027 0 00-.757 1.236c.124.543.679.887 1.236.757l.311-.07a1.027 1.027 0 00.757-1.236 1.04 1.04 0 00-1.236-.757zm6.456 0l-.312.07a1.027 1.027 0 00-.756 1.236c.124.543.678.887 1.236.757l.311-.07a1.027 1.027 0 00.757-1.236 1.04 1.04 0 00-1.236-.757z"
            />
          </svg>
        )}
        {isRadioMode && (
    ...
    >
      ...
      <div
        className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${
          isRadioMode ? 'bg-[#f5a623] shadow-md shadow-[#f5a623]/20' : 'bg-[#f5a623]/15'
        }`}
      >
        {radioLoading ? (
          <div
            className={`w-4 h-4 border-2 rounded-full animate-spin ${
              isRadioMode
                ...
                : 'border-[#f5a623] border-t-transparent'
            }`}
          />
        ) : (
          <svg
            className={`w-5 h-5 ${isRadioMode ? 'text-black' : 'text-[#f5a623]'}`}
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth={1.5}
