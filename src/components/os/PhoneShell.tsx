  ...
  return (
    <div className="flex min-h-[100dvh] flex-col bg-[#0a1628] pb-[calc(5rem+env(safe-area-inset-bottom,0px))]">
      ...
      <div className="mx-auto w-full max-w-4xl">
        ...
        {/* Widgets */}
        <div className="flex flex-col gap-2.5 px-4 py-3 sm:px-8">
        ...
        <div className="px-4 pt-2 sm:px-8">
          <div className="mb-2 flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs text-[#f5a623]/60 transition-colors hover:text-[#f5a623] focus-visible:ring-2 focus-visible:ring-[#f5a623]"
            >
              Edit
            </button>
          </div>
