...
const PLATFORMS: {
  ...
  },
  {
    ...
    label: 'Spotify',
    abbr: 'SP',
    urlFn: (v) => (v.startsWith('http') ? v : `https://open.spotify.com/artist/${v}`),
  ...
  },
  {
    ...
    label: 'SoundCloud',
    abbr: 'SC',
    urlFn: (v) => (v.startsWith('http') ? v : `https://soundcloud.com/${v}`),
  ...
  },
  {
    ...
    label: 'YouTube',
    abbr: 'YT',
    urlFn: (v) => (v.startsWith('http') ? v : `https://youtube.com/${v}`),
  ...
  },
  {
    ...
    label: 'Bluesky',
    abbr: 'BS',
    urlFn: (v) => `https://bsky.app/profile/${v}`,
  ...
  },
  {
    ...
    label: 'TikTok',
    abbr: 'TT',
    urlFn: (v) => (v.startsWith('http') ? v : `https://tiktok.com/@${v}`),
  ...
  },
  {
    ...
    abbr: 'AM',
    urlFn: (v) => v,
    color: 'hover:bg-pink-400/20 hover:text-pink-300',
  },
  {
    key: 'twitch',
    label: 'Twitch',
    abbr: 'TW',
    urlFn: (v) => (v.startsWith('http') ? v : `https://twitch.tv/${v}`),
    color: 'hover:bg-purple-400/20 hover:text-purple-300',
  },
  {
    key: 'website',
    label: 'Website',
    abbr: 'WB',
    urlFn: (v) => (v.startsWith('http') ? v : `https://${v}`),
    color: 'hover:bg-[#f5a623]/20 hover:text-[#f5a623]',
  },
];
