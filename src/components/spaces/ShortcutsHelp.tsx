    ...
    >
      ...
      >
        ...
        <p className="mt-5 text-gray-600 text-xs leading-relaxed">
          Shortcuts are off while typing in chat. Press{' '}
          <kbd className="px-1 rounded bg-[#1a2a3a] text-gray-300 text-[10px] font-mono">?</kbd> in
          the room any time to reopen this.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <li className="flex items-start justify-between gap-3 py-1.5 px-3 rounded-lg bg-[#0a1628] border border-white/[0.04]">
      <div className="min-w-0">
        ...
        {shortcut.hint && <p className="text-gray-500 text-xs leading-snug">{shortcut.hint}</p>}
      </div>
