      ...
      {!isHost && (
        <div className="space-y-2">
          <input
            ...
            className="w-full bg-white/5 border border-gray-700 rounded-lg px-3 py-2 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-[#f5a623]/50"
          />
          <input
            type="text"
            value={title}
