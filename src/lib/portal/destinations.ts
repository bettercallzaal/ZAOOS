    ...
    destinations: [
      {
        ...
        description: 'Music battles & NFT jukebox',
        external: true,
      },
      {
        name: 'WaveWarZ',
        url: 'https://www.wavewarz.com',
        description: 'Music prediction markets',
        external: true,
      },
      {
        name: 'SongJam',
        url: 'https://songjam.space/zabal',
        description: 'Live audio spaces',
        external: true,
      },
      {
        name: 'Audius',
        url: 'https://audius.co/dopestilo/album/ambition',
        description: 'Stream ZAO playlists',
        external: true,
      },
    ],
  },
    ...
    destinations: [
      {
        name: 'ZAO OS',
        url: 'https://zaoos.com',
        description: 'Main community app',
        external: true,
      },
      {
        name: 'Discord',
    ...
    destinations: [
      {
        ...
        description: 'Community bounties',
        external: true,
      },
      {
        name: 'Clanker',
        url: 'https://clanker.world',
        description: '$ZABAL token',
        external: true,
      },
      {
        name: 'Empire Builder',
    ...
    destinations: [
      {
        ...
        description: 'On-chain proposals & NFT auctions',
        external: true,
      },
      {
        name: 'Snapshot',
        url: 'https://hub.snapshot.org',
        description: 'Gasless governance polls',
        external: true,
      },
    ],
  },
  {
    ...
    destinations: [
      { name: 'Member Home', url: '/home', description: 'Full ZAO OS experience', external: false },
      {
        ...
        description: 'Verify real-world connections',
        external: true,
      },
    ],
  },
